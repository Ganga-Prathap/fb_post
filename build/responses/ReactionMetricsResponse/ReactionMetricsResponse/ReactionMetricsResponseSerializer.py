...
class ReactionMetricsResponseType(object):
    def __init__(self, reaction_type, count,  **kwargs):
...
class ReactionMetricsResponseSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return ReactionMetricsResponseType(**validated_data)
