...
from fb_post.build.view_environments.posts__post_id__comment_v1_.create_comment.post.postSerializer import postSerializer
...
def create_comment(request, *args, **kwargs):
    ...
    return view_env_wrapper(app_name, "create_comment", group_name, *args, **kwargs)
