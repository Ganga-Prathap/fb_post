path_method_dict = {
    "posts/(?P<post_id>\\d+)/details/v1/": {
        "GET": "post_details"
    }
}


def posts__post_id__details_v1_(request, *args, **kwargs):
    ...
    response = router_wrapper("fb_post", "posts__post_id__details_v1_", operations_dict, request, *args, **kwargs)
    return response