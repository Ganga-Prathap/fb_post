...
class UserPostsDetailsRequestQueryParamType(object):
...
class UserPostsDetailsRequestQueryParamSerializer(serializers.Serializer):
    ...
    def create(self, validated_data):
        return UserPostsDetailsRequestQueryParamType(**validated_data)
