class PostParameter(object):
    ...
    def get_param_name():
        param_names = {
            "parameter_name": "CreateReactionParameter",
    ...
    def get_serializer_class():
        serializer_options = {
            ...
            "param_serializer_import_str": "from fb_post.build.parameters.CreateReactionParameter.post.postSerializer import postSerializer",
